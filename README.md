...
pixi global install r-partykit
```
...
It is possible to list all of the versions of `r-partykit` available on your platform:
...
```
pixi search r-partykit --channel conda-forge
```
